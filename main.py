...
# 1. Correction globale pour éviter les crashs d'encodage UTF-8 sur Render / Linux
...
# Configuration des variables d'environnement et du port
...
async def main():
    ...
    # Gestion synchrone du cycle de vie du bot pour éviter l'erreur sur Python 3.14
    async with telegram_app:
        await telegram_app.start()
        await telegram_app.updater.start_polling(drop_pending_updates=True)
        logger.info("🤖 Bot Telegram actif et prêt !")
